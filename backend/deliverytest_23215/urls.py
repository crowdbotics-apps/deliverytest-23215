"""deliverytest_23215 URL Configuration
...
admin.site.site_header = "deliveryTest"
admin.site.site_title = "deliveryTest Admin Portal"
admin.site.index_title = "deliveryTest Admin"

# swagger
api_info = openapi.Info(
    title="deliveryTest API",
    default_version="v1",
    description="API documentation for deliveryTest App",
)
